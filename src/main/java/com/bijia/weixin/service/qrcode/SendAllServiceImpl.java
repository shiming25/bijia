...
public class SendAllServiceImpl {
     ...
     * <br>
     */
    public void uploadTempMediaService() {
        // 获取accesssTocken
        ApiConfig config = new ApiConfig(WeixinConstants.APPID, WeixinConstants.SECRET);
        // 上传
        MediaAPI api = new MediaAPI(config);
//        UploadMediaResponse response = api.uploadTmpMedia(MediaType.IMAGE, new File("E:/temp/test/m1.png"));
        UploadMediaResponse response = api.uploadTmpMedia(MediaType.VIDEO, new File("E:/temp/test/m1.mp4"));
