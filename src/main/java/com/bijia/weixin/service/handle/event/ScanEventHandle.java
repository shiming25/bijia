...
public class ScanEventHandle<E extends BaseEvent> implements EventHandle<E> {
    /**
     * 日志
     */
    public static final Logger log = LoggerFactory.getLogger(ScanEventHandle.class);
    /**
     * 提示信息
     */
    ...
    public boolean beforeHandle(E event) {
        ...
        if (event != null && EventType.SCAN.equalsIgnoreCase(event.getEvent())) {
            return true;
        }
        return false;
    }
